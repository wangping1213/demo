...
//    private static String dateWhiteSpacePattern = "yyyy MM dd";
//    private static String dateTimeWhiteSpacePattern = "yyyy MM dd HH:mm:ss";
//    private static String dateWhitNothingPattern = "yyyyMMdd";
//    private static String dateTimeWhitNothingPattern = "yyyyMMdd HH:mm:ss";
//    static {
//        Locale locale = LocaleContextHolder.getLocale();
//        //尝试试从messages_zh_Cn.properties中获取defaultDatePattner.
//        try {
//        	datePattern = ResourceBundle.getBundle(Constants.MESSAGE_BUNDLE_KEY, locale).getString("date.default_format");
//        }
